...
// 判断节点是否是红色
template<typename K, typename V>
bool RedBlockTree<K, V>::isRed(TreeNode<K, V>* t) {
...
// 判断树是否为空
template<typename K, typename V>
bool RedBlockTree<K, V>::isEmpty() {
    return root == nullptr;
}

// 寻找树中的最小节点
template<typename K, typename V>
TreeNode<K, V>* RedBlockTree<K, V>::findMin(TreeNode<K, V>* t) {
    if (t->left == nullptr)
        return t;
    else
...
// 寻找树中最大值
template<typename K, typename V>
TreeNode<K, V>* RedBlockTree<K, V>::findMax(TreeNode<K, V>* t) {
    if (t->right == nullptr) 
        return t;
    else 
...
// LL单旋转
template<typename K, typename V>
TreeNode<K, V>* RedBlockTree<K, V>::rotateWithLeft(TreeNode<K, V>* k2) {
...
// RR单旋转
template<typename K, typename V>
TreeNode<K, V>* RedBlockTree<K, V>::rotateWithRight(TreeNode<K, V>* k1) {
...
// 翻转节点及其两个子节点的颜色
template<typename K, typename V>
void RedBlockTree<K, V>::colorConversion(TreeNode<K, V>* node) {
...
// 恢复红黑树性质
template<typename K, typename V>
TreeNode<K, V>* RedBlockTree<K, V>::balance(TreeNode<K, V>* t) {
    // 有红色右连接则RR旋转
...
// 删除最小值
template<typename K, typename V>
TreeNode<K, V>* RedBlockTree<K, V>::deleteMin(TreeNode<K, V>* t) {
...
// 右调整
template<typename K, typename V>
TreeNode<K, V>* RedBlockTree<K, V>::moveRedRight(TreeNode<K, V>* t) {
    colorConversion(t);
...
// 删除最大值
template<typename K, typename V>
TreeNode<K, V>* RedBlockTree<K, V>::deleteMax(TreeNode<K, V>* t) {
...
// 删除任意节点
template<typename K, typename V>
TreeNode<K, V>* RedBlockTree<K, V>::deleted(TreeNode<K, V>* t, K key) {
    if (key < t->key) {
        // 左节点是2-节点
        if (!isRed(t->left) && !isRed(t->left->left)) {
            t = moveRedLeft(t);
...
// 中序遍历
template<typename K, typename V>
void RedBlockTree<K, V>::inorderTraversal(TreeNode<K, V>* t) {
    if (t != nullptr) {
...
// 查找节点
template<typename K, typename V>
TreeNode<K, V>* RedBlockTree<K, V>::searchKey(TreeNode<K, V>* t, K key) {
    if (!t) return nullptr;
    if (key == t->key) 
        return t;
    else if (key > t->key) 
...
// 删除最小值
template<typename K, typename V>
void RedBlockTree<K, V>::deleteMin() {
    if (isEmpty()) return;
...
// 删除最大值
template<typename K, typename V>
void RedBlockTree<K, V>::deleteMax() {
    if (isEmpty()) return;
    if (!isRed(root->left) && !isRed(root->right)) {
        root->color = RED;
    }                
...
// 删除任意节点
template<typename K, typename V>
void RedBlockTree<K, V>::deleted(K key) {
    if (isEmpty()) return;
...
// 递归的中序遍历
template<typename K, typename V>
void RedBlockTree<K, V>::inorderTraversal() {
    if (root == nullptr) {
...
// 插入数据到树中
template<typename K, typename V>
void RedBlockTree<K, V>::insert(K key, V data) {    
...
// 搜索节点
template<typename K, typename V>
void RedBlockTree<K, V>::searchKey(K key) {
